...
public class GlobalDefaultExceptionHandler {
    ...
    /**
     * Método para manejar la excepcion PayDomainException
	 *
     * @param e PayDomainException
	 * @return la excepción en formato Json
	 */
    @ExceptionHandler(PayDomainException.class)
    @RequestMapping(produces = "application/json")
    @ResponseBody
    public ResponseEntity<ErrorPayload> handleTodoDomainException(PayDomainException e) {
