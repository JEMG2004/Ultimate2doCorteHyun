...
public class ProductController {
     ...
     */
    /*@RequestMapping(value = "{id}/productcategories", method = RequestMethod.GET, produces = "application/json")
    @ResponseBody
    public List<Category> findCategories(@PathVariable Long id) throws ResourceNotFoundException {
        return (List<Category>)  productService.findById(id).getCategories();
    }*/
